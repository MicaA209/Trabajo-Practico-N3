...
void ejecutarPunto1()
{
	...
	std::cout << "-----------------------------------------" << std::endl;
	std::cout << "----SISTEMA DE CONTROL DE UNIVERSIDAD----" << std::endl;
	std::cout << "-----------------------------------------" << std::endl;
	std::cout << "Requerira ingresar " << notasMax <<" notas de una\nlista de estudiantes definida por el usuario\n" << std::endl;
