...
void ejecutarPunto4()
{
	...
	do 
	{
		std::cout << "En que posicion desea ubicar al cliente?" << std::endl;
		posicionSolicitada = entradaLimpia<int>();
	} 
	while (!vip.agregarPosicion(nombreTemp, montosTemp, posicionSolicitada));
